...
1. Travel Cost attenuation (Jovin)
2. Zero Market Share Issue (Jovin, Ryan)
3. Continue to work on estimation (migrant merging) (Matt, Ryan)
4. Set up a meeting with both the Jacobs (Raahil)
