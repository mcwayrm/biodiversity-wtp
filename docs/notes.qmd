...
- Still gathering geospatial data
    ...
    - [ERA5-Land 2m temperature data](https://cds.climate.copernicus.eu/datasets/reanalysis-era5-land?tab=download)
...
4. Looking ahead
    - Look at code for estimating mixed logit with big data
        - [mixl](https://github.com/joemolloy/fast-mixed-mnl)
