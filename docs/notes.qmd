...
2. Need to select a user group for the main paper (All users, above/below median)
3. Travel cost update (Jovin/Matt)
...
6. Explore how to estimate individual WTP from mixed logit
