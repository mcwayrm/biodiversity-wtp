...
if(module == 'cluster'){
  ...
  saveRDS(master, paste('./data/intermediate/master/master_cs', radius, 'km_clust_', clust_size,'km.rds', sep=''))
  print('fin!')
} else{
  
  saveRDS(master, paste('./data/intermediate/master/master_cs', radius, 'km.rds', sep=''))
  print('fin!')
}
